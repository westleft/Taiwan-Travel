...
export const apiGetHotelList = () => tourismList.get("Hotel?%24top=200&%24format=JSON")
export const apiGetScenicSpotList = () => tourismList.get("ScenicSpot?%24top=150&%24format=JSON")

// 搜尋
export const apiGetSearch = (city: string) => tourismList.get(`https://ptx.transportdata.tw/MOTC/v2/Tourism/ScenicSpot?%24filter=contains(Address%2C'${city}')&%24format=JSON`)